...
class ScanningBluetooth : AppCompatActivity() {
    ...
    //Declare button and RecyclerView Here
    private lateinit var scan: Button

    //Bluetooth LE connection properties, hardware adapter, scanner
    ...
    private var isScanning = false
        /*set(value) {
            field = value
            runOnUiThread { scan.text = if (value) "Stop Scan" else "Start Scan" }
        }*/
...
/*
    ...
    //Private functions for the scanning activity
